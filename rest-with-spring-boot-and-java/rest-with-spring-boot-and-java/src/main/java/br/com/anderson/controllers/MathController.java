...
import br.com.anderson.math.SimpleMath;
...
public class MathController {
    ...
    public Double mean(
        ...
        return math.mean(NumberConverter.convertToDuble(numberOne), NumberConverter.convertToDuble(numberTwo));
    }
    ...
    public Double squareRoot(
        ...
        return math.squareRoot(NumberConverter.convertToDuble(number));
    }
}
